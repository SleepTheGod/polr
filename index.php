...
<form id='shortenform' method="POST" action="createurl.php" role="form">
              <input type='text' class="form-control" placeholder="URL" id="url" value="Enter Site URL" name="urlr"  onfocus="if(this.value == 'Enter Site URL') { this.value = ''; }" onfocusout="this.value = 'Enter Site URL'" />
    <div id='options'>
        <br />
